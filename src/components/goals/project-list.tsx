...
function ProjectRow({
  ...
  if (editing) {
    return (
      <li className="rounded-2xl imx-surface imx-surface-rim p-4">
  ...
  return (
    <li className="group rounded-2xl imx-surface imx-surface-rim p-4 transition-colors hover:border-border">
